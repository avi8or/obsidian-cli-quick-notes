...
Previous: pr-02-links (9bbb6fa63923f4caf1b9e8261ad130d8f6df8755)
This PR: pr-03-delete (bb3ac193957520e59fdb76100c66bc112576d15f)

## Incremental Diff (vs previous in stack)

Compare: pr-02-links..pr-03-delete
...
@@ -282,14 +284,55 @@ obsidian-cli move "{current-note-path}" "{new-note-path}" --open --editor
...
```
 ...
 16 files changed, 815 insertions(+), 89 deletions(-)
```
...
@@ -121,7 +173,9 @@ obsidian-cli open "{note-name}" --vault "{vault-name}"
...
+Note: creation/templates are controlled by Obsidian’s daily note settings/plugins.
 ...
 ```bash
 # Creates / opens daily note in obsidian vault
@@ -230,14 +284,55 @@ obsidian-cli move "{current-note-path}" "{new-note-path}" --open --editor
